...
WebUI.setText(findTestObject('Page_info/Page_info_general/input_ldapId'), 'LDAP_DOMAIN')

WebUI.setText(findTestObject('Page_info/Page_info_general/input_ldapPassword'), '')

WebUI.setText(findTestObject('Page_info/Page_info_general/input_ldapUserName'), 'OU=Members,DC=TEST,DC=CO,DC=KR')

WebUI.setText(findTestObject('Page_info/Page_info_general/input_ldapGroupName'), 'OU=Groups,DC=TEST,DC=CO,DC=KR')
...
WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapServer'), 'value', 'LDAP_SERVER', 
    0)

WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapPort'), 'value', '389', 0)

WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapId'), 'value', 'LDAP_DOMAIN', 
    0)

WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapPassword'), 'value', '', 0)

WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapUserName'), 'value', 'OU=Members,DC=TEST,DC=CO,DC=KR', 
    0)

WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapGroupName'), 'value', 'OU=Groups,DC=TEST,DC=CO,DC=KR', 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapPassword'), 'value', ldapPassword, 
    0)

WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapUserName'), 'value', ldapUserName, 
    0)

WebUI.verifyElementAttributeValue(findTestObject('Page_info/Page_info_general/input_ldapGroupName'), 'value', ldapGroupName, 
    0)
